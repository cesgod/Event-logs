...
#echo "Echo: <img src='../../../pdf/ACCIONES.svg'>";
#die();
/**
...
#$pdf->ImageSVG($file='../../../pdf/ACCIONES.svg', $fitonpage=true);

$pdf->ImageSVG($file='../../../pdf/ACCIONES.svg', $x=30, $y=100, $w='', $h=100, $link='', $align='', $palign='', $border=0, $fitonpage=false);
